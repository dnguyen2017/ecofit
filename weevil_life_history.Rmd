...
rmark_names <- names(weevil.results) %>% head(-1) 
# create named vector of model names I want to use
model_names <- c("S.dot" = "survival ~ intercept", "S.shell" =  "survival ~ shell", 
                 "S.sex" = "survival ~ sex", "S.sexshell" = "survival ~ sex + shell")
...
coef_df %>%
  ...
  facet_wrap(~model, scales = "free", nrow = 4) +
  coord_flip() +
  labs(x = element_blank(),
       y = "parameter estimate (logit scale)",
