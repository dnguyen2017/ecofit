...
Note that the 3 % shell experiment is short because it was started at a later date than all other experiments, but was ended at the same time as all othger experiments. I'm guessing it was done to check if what the behavior was like between 0 and 5 %. It seems that it was more like the 0 % treatment.
...
The treatments each had an "acclimation phase" at the beginning for populations to establish. Then the treatments were ramped up linearly.
...
control populations were kept on pure (0 % peanut shell) beans. As with data we looked at earlier, populations on pure bean reach a stochastic carrying capacity.
...
Food quality experiments. The percentage of peanut shells increased (i.e., food quality decreased) over time in these experiments. These populations actually crashed, unlike in the harvesting experiments. It would be interesting to see if we can use parameter estimates from the constant food quality experiments to predict how weevils responsed to this increasing decline in food quality. Could be relevent for people that are trying to study how populations respond to climate change or habitat degredation.
...
what is the column at the end that has the repeating sequence {a,b,c,d}?
